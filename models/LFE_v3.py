...
class LFE(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.conv_64_2  = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, padding=1, groups=2) # Grouped convolution
        ...
        self.conv_128_2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, padding=1, groups=4) # Grouped convolution
        ...
        self.conv_256_2 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, padding=1, groups=8) # Grouped convolution
